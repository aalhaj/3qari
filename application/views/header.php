...
<html>
	<head>
		...
		<!-- Styles -->
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/libs/jqueryui/jquery-ui.css";?>" type="text/css" >
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/css/bootstrap.min.css"; ?>" type="text/css" /><!-- Bootstrap -->
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/font-awesome-4.0.3/css/font-awesome.css"; ?>" type="text/css" /><!-- Font Awesome -->
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/css/nv.d3.css"; ?>" type="text/css" /><!-- VISITOR CHART -->
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/css/daterangepicker-bs3.css"; ?>" type="text/css" media="all"/><!-- Date Range Picker -->
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/css/style.css"; ?>" type="text/css" /><!-- Style -->
		<link rel="stylesheet" href="<?php echo base_url() . "application/assets/css/responsive.css"; ?>" type="text/css" /><!-- Responsive -->
	</head>
	<body>
			<div class="responsive-menu">
				...
				<li><a href="#" title="" ><i class="fa fa-thumbs-o-up"></i><span><i>6+</i></span>Bonus</a>
					<ul>
						...
						<li><a href="index-2.html" title="">Log in</a></li>
		...
		<header>
			<div class="logo">
				<img src="<?php echo base_url() . "application/assets/images/logo.png"; ?>" alt="" />
			</div>
				...
				<ul>
					...
					<li><a title="" class="message-btn"><i class="fa fa-envelope"></i><span>3</span></a>
						<div class="message">
							...
							<a href="#" title=""><img src="<?php echo base_url() . "application/assets/images/notification1.jpg"; ?>" alt="" />Hey! How are You Diana. I waiting for you.
							toe Check. <p><i class="fa fa-clock-o"></i>3:45pm</p></a>
							<a href="#" title=""><img src="<?php echo base_url() . "application/assets/images/notification1.jpg"; ?>" alt="" />Please Can you Submit A file. I am From Korea
							toe Check. <p><i class="fa fa-clock-o"></i>1:40am</p></a>
							<a href="#" title=""><img src="<?php echo base_url() . "application/assets/images/notification1.jpg"; ?>" alt="" />Hey Today is Party So you Will Have to Come <p><i class="fa fa-clock-o"></i>4 Hours ago</p></a>
					...
					<li><a title="" class="notification-btn"><i class="fa fa-bell"></i><span>4</span></a>
						<div class="notification">
							...
							<a href="#" title=""><img src="<?php echo base_url() . "application/assets/images/notification1.jpg"; ?>" alt="" />Server 3 is Over Loader Pleas
							toe Check. <p><i class="fa fa-clock-o"></i>3:45pm</p></a>
							<a href="#" title=""><img src="<?php echo base_url() . "application/assets/images/notification1.jpg"; ?>" alt="" />Server 10 is Over Loader Pleas
							toe Check. <p><i class="fa fa-clock-o"></i>1:40am</p></a>
							<a href="#" title=""><img src="<?php echo base_url() . "application/assets/images/notification1.jpg"; ?>" alt="" />New User Registered Please Check This <p><i class="fa fa-clock-o"></i>4 Hours ago</p></a>
				...
				<div id="scrollbox4" class="right-bar">
					...
					<div class="users-online">
						...
						<div class="user-online2">
							<ul>
								<li><img src="<?php echo base_url() . "application/assets/images/user1.jpg"; ?>" alt="" /><h5><a href="#" title="">Johny Razell</a></h5><span class="offline">OFFLINE</span> </li>
								<li><img src="<?php echo base_url() . "application/assets/images/user2.jpg"; ?>" alt="" /><h5><a href="#" title="">John Smith</a></h5><span class="online">ONLINE</span> </li>
								<li><img src="<?php echo base_url() . "application/assets/images/user3.jpg"; ?>" alt="" /><h5><a href="#" title="">Doe Haxzer</a></h5><span class="online">ONLINE</span> </li>
								<li><img src="<?php echo base_url() . "application/assets/images/user4.jpg"; ?>" alt="" /><h5><a href="#" title="">Karen Kelly</a></h5><span class="unread"><i>4</i></span>
		...
		<div class="menu">
			<div class="menu-profile" id="intro3">
				<img src="<?php echo base_url() . "application/assets/images/profile-image.jpg"; ?>" alt="" />
				<span><i class="fa fa-plus"></i></span>
				<div class="menu-profile-hover">
					<h1><i>Brian</i> Kelly</h1>
					<p><i class="fa fa-map-marker"></i>LONDON, UNITED KINGDOM</p>
					<a href="index-2.html" title=""><i class="fa fa-power-off"></i></a>
