...
function Timeline(cvs) {
    ...
    self.dotColors = [
        ['#3db2fd', 'rgba(61, 178, 253, 0.3)', 'rgba(61, 178, 253, 0.08)'],
        ['#FD3D46', 'rgba(253, 61, 70, 0.3)', 'rgba(253, 61, 70, 0.12)'],
    ];
    ...
    function init() {
        ...
        try {
            ...
            self.lines[0] = new Line(0, canvas.offsetHeight - 100, '#3db2fd', self.options, mouse);
            self.lines[1] = new Line(0, canvas.offsetHeight - 100, '#FD3D46', self.options, mouse);
